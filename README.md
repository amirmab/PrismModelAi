...
| 4 | **Layer 16–20** (Cross-Domain Reasoning) | SERG rule fires: `IF temperature < DUCTILE_BRITTLE_TRANSITION THEN RISK::BRITTLE_FRACTURE: 2.0`. Bridge structural loads interact via attention bridge with metallurgy domain. | `RISK::BRITTLE_FRACTURE: 2.0`, `SYS::ENTROPY: -0.8` (degraded) |
